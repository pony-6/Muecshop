...
function assign_template($ctype = '', $catlist = array())
{
    ...
    $sql = "select value from  ecs_shop_config  where  code = 'qr_code' ";
    $qr_code = $GLOBALS['db']->getRow($sql);
    $smarty->assign('qr_code',        $qr_code);  //店铺二维码
...
//    var_dump($result['goods_number']);die;
    $smarty->assign('goods_num',        $result['goods_number']);  //购物车数量
