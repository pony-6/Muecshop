...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('ad'). " (position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,link_man,link_qt,link_email,link_phone,click_count,enabled)
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('position_list', get_position_list());
	$smarty->assign('cat_list',  cat_list(0, $ads_arr['link_qt'], true));
   // $smarty->assign('cat_list',   cat_list());
