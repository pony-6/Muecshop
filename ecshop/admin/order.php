...
elseif ($_REQUEST['act'] == 'delivery_ship')
{
    ...
    $delivery['invoice_name'] = isset($_REQUEST['invoice_name']) ? trim($_REQUEST['invoice_name']) : '';
    ...
    $_delivery['invoice_name']  = $invoice_name;
    if (!$query)
    {
        /* 操作失败 */
    ...
    $sql = "update ecs_order_info set invoice_name ='".$invoice_name."' where order_sn='".$order['order_sn']."'";
