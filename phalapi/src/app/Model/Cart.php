...
class Cart extends NotORM
{
    ...
    function update_cart_nums($goods_id, $num = 1, $user_id,$product_id){
        ...
        $sql = "update ecs_cart set goods_number='".$num."' where goods_id ='".$goods_id."' and product_id = '".$product_id."' and user_id='".$user_id."'";
...
//        }
        $data = array(
            ...
            'goods_thumb'=>$package['package_image'],
...
//                var_dump('123');
    ...
    function doFastcheck($goods_id,$user_id,$num,$product_id){
        ...
        $sql = "update ecs_cart set is_checked = 'true',goods_number = '".$num."' where user_id='".$user_id."' and goods_id='".$goods_id."' and product_id = '".$product_id."'";
        $this->getORM()->queryRow($sql);
        return true;
    }
