...
class Brand extends NotORM
{
    ...
    public function getBrandDetailAction($page, $id)
    {
        // 品牌的详情页
        $page_size = getConfigPageSize();
        $offset = ($page - 1) * $page_size;
        ...
        $sql = "SELECT goods_id,goods_name AS name,shop_price AS retail_price,goods_thumb AS list_pic_url FROM ecs_goods WHERE brand_id = {$id} LIMIT {$offset},{$page_size}";
