    ...
    public function getRules() {
        return array(
            'goodsAddCollectApi' => array(
                'user_id' => array('name' => 'user_id', 'require' => false, 'min' => 1, 'max' => 50, 'desc' => '用户名'),
                'token' => array('name' => 'token', 'require' => false, 'min' => 1, 'max' => 32, 'desc' => 'token'),
            ...
            'addressDetailApi' => array(
                ...
                'user_id' => array('name' => 'user_id', 'require' => false, 'min' => 1, 'max' => 100, 'desc' => 'user_id'),
                'token' => array('name' => 'token', 'require' => false, 'min' => 1, 'max' => 32, 'desc' => 'token'),
            ),
            ...
            'addaddressDetailActionApi' => array(
                ...
                'user_id' => array('name' => 'user_id', 'require' => false, 'min' => 1, 'max' => 20, 'desc' => '会员ID'),
         ...
         "GetPromoteApi" => array(
            ...
            "securityphoneUpdateBeforeApi" => array(
                ...
                'user_id' => array('name' => 'user_id', 'require' => false, 'min' => 1, 'max' => 50, 'desc' => '用户名'),
                'token' => array('name' => 'token', 'require' => false, 'min' => 1, 'max' => 32, 'desc' => 'token'),
                'verCode' => array('name'=>'verCode','require'=>true,'min'=>6,'desc'=>'验证码')
            ),
...
//        die;
    ...
    public function memberInfoApi()
    {
        ...
        return array('res' => true, 'info'=>$data,"allOrderNum"=>$order_num,"rank_name"=>$rank_name,"logo_other"=>$logo_oter,'kefu_tel'=>$kefu_tel);
    ...
    public function logo(){
        $logo_oter = $this->model->logo_other();
        return array("logo_other"=>$logo_oter);
    }
